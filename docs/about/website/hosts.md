...
| [statichost](https://statichost.eu/)            | [0xfab1@statichost](https://builder.statichost.eu/0xfab1/)      | TODO: https://statichost.0xfab1.net |

Services to try (again):

| Service                                                  | Comment                                                                                                     |
| -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| [Azure](https://azure.microsoft.com)                     | Broke (my fault)... need to re-create this                                                                  |
| [IPFS](https://ipfs.io/) with [fleek](https://fleek.co/) | Broke (my fault)... need to re-create this                                                                  |
