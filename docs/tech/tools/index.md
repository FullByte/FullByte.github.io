...
| Purpose  | 0xfab1                        | Tool                                             |
|----------|-------------------------------|--------------------------------------------------|
| Videos   | [yt-dlp](cli/yt-dlp.md)           | [yt-dlp](https://github.com/yt-dlp/yt-dlp)       |
| Torrents | [qbittorrent](files/qbittorrent.md) | [qbittorrent](https://www.qbittorrent.org/)      |
| IRC XDCC | [irc](collab/irc.md)                 | [mirc](https://www.mirc.com/)                    |
| Images   | [gallery-dl](cli/gallery-dl.md)   | [gallery-dl](https://github.com/mikf/gallery-dl) |
| Files    | [wget](cli/wget.md)               | [wget](https://ftp.gnu.org/gnu/wget/)            |
...
|-----------------|---------------------------|------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|
| Cloud           | [rclone](files/rclone.md)       | [rclone](https://rclone.org/)                                                                        | Encryption possible, no client needed, many vendors supported                                      |
| Local drive/NAS | [RoboCopy](files/robocopy.md)   | [RoboCopy](https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/robocopy) | Already installed, has sync option, works.                                                         |
| SFTP/WebDAV     | [WinSCP](files/winscp.md)       | [WinSCP](https://winscp.net)                                                                         | Scripting possible using winscp.com                                                                |
| Sync P2P        | [Syncthing](files/syncthing.md) | [Syncthing](https://syncthing.net/)                                                                  | Use [SyncTrayzor](https://github.com/canton7/SyncTrayzor) for GUI and sync files via peer-to-peer. |
| Backup Server   | [Restic](files/restic.md)       | [Restic](https://restic.net/)                                                                        | Good for regular backups. Uses rclone in the backend.                                              |
...
|---------------|--------------------------------|----------------------------------------|
| Text          | [Pandoc](cli/pandoc.md)            | [Pandoc](https://pandoc.org/)          |
| Audio & Video | [FFmpeg](cli/ffmpeg.md)            | [FFmpeg](https://ffmpeg.org/)          |
| Pictures      | [ImageMagick](cli/image-magick.md) | [ImageMagick](https://imagemagick.org) |
| eBooks        | [Calibre](files/calibre.md)          | [Calibre](https://calibre-ebook.com/)  |
