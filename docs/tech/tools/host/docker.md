...
| [Azure PowerShell](https://mcr.microsoft.com/en-us/product/azure-powershell/about) | Azure ready command line                                                                                      | ```docker run -it mcr.microsoft.com/azure-powershell```                                                                                                                                                                                     |
